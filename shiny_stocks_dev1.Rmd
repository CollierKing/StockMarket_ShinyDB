...
# tableSumm2 <- eventReactive(input$clickMeFinancials,{
#                       
#     ticker <- input$inTextFinancials
...
Technicals - Events
    ...
    * Correct order of event count (ex: 1,2,..10, not 1,10,2..)
    * add bars to table?
