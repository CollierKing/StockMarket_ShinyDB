...
output$stock_link <- renderUI({
        ...
        validate(
          need(input$inText != "" | input$tbl1_rows_selected != "", "Please select or enter a ticker")
        )
...
event_chart <- reactive({
    ...
    validate(
      need(input$inText4 != "", "Please enter a ticker")
    )
    
    validate(
      need(input$tbl3_rows_selected != "", "Please select an event in the Event Summary table.")
    )
